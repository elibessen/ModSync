...
- It accesses the local .minecraft folder to read installed mods and Minecraft versions, and to update mod files.
...
- Fabric mods only
- `.jar` files with `fabric.mod.json`
Forge / NeoForge mods are ignored
